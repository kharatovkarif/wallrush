...
const ADMIN_CSS = `
  :root {
    --bg: #0f111c; --card: #191d2e; --line: #232842; --ink: var(--ink); --dim: var(--dim); --faint: var(--faint);
    --accent: #2f6df6; --accent-soft: rgba(47, 109, 246, .16);
  ...
  * { box-sizing: border-box; }
  ...
  .bar .fill { width: 100%; background: linear-gradient(180deg, #5b8cff, var(--accent)); border-radius: 5px 5px 0 0; min-height: 2px; }
  ...
  .geo .track i { display: block; height: 100%; background: linear-gradient(90deg, #5b8cff, var(--accent)); border-radius: 4px; }
  ...
  .pc-avatar { width: 38px; height: 38px; border-radius: 50%; flex: none; background: linear-gradient(135deg, #5b8cff, var(--accent)); display: grid; place-items: center; font-weight: 700; color: #fff; }
  ...
  #admProg {
    ...
    background: linear-gradient(90deg, #5b8cff, var(--accent)); box-shadow: 0 0 8px var(--accent);
