...
export const I18N = {
  ru: {
    ...
    mode_wall_h: 'Стенка',
    mode_wall_v: 'Стенка',
    wall_mode_hint: 'Нажми на поле, куда поставить стенку',
    no_walls_left: 'Стенки закончились',
    walls_left: 'стены',
    game_win: 'Победа! 🎉',
    game_lose: 'Поражение',
  ...
  en: {
    ...
    mode_wall_h: 'Wall',
    mode_wall_v: 'Wall',
    wall_mode_hint: 'Tap the board where to place the wall',
    no_walls_left: 'No walls left',
    walls_left: 'walls',
    game_win: 'Victory! 🎉',
    game_lose: 'Defeat',
