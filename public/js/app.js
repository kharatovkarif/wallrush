...
import { initialState, applyMove, pawnMoves, canPlaceWall, goalRow, cloneState, N } from './engine.js?v=45';
import { aiMove } from './ai.js?v=45';
import { makeT } from './i18n.js?v=45';
...
function getAiWorker() {
  ...
  if (!aiWorker) {
    try {
      aiWorker = new Worker('js/ai-worker.js?v=45', { type: 'module' });
