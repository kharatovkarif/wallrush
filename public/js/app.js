...
import { initialState, applyMove, pawnMoves, canPlaceWall, goalRow, cloneState, N } from './engine.js?v=46';
import { aiMove } from './ai.js?v=46';
import { makeT } from './i18n.js?v=46';
...
function getAiWorker() {
  ...
  if (!aiWorker) {
    try {
      aiWorker = new Worker('js/ai-worker.js?v=46', { type: 'module' });
